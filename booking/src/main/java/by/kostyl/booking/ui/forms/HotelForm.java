...
public class HotelForm extends FormLayout {
	...
	public void bindForm() {
		// converters and validators,also required = true for all fields unless
		// description field
		hotelBinder.forField(rating).asRequired("This is required field")
		...
		hotelBinder.forField(name).asRequired("This is required field").bind(Hotel::getName, Hotel::setName);

		hotelBinder.forField(address).asRequired("This is required field").bind(Hotel::getAddress, Hotel::setAddress);
		...
		hotelBinder.forField(operatesFrom).asRequired("This is required field")
	...
	public void setHotel(Hotel hotel) {
		refresh();
		category.setSelectedItem(hotel.getCategory());
		this.hotel = hotel;
